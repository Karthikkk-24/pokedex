        ...
        <div className='w-full h-auto flex items-center justify-center gap-3'>
                        ...
                        <div className="w-[60%] h-[60%] bg-white flex flex-col items-center justify-center gap-5 rounded-3xl shadow-2xl border-2 border-slate-200">
                            ...
                            <div className=" aspect-square rounded-2xl h-full w-full grid grid-cols-5 gap-5 p-8">
                                {pokemonTypes.map((type, index) => (
                                    <div
                                        key={type}
                                        className="h-16 w-auto px-2 rounded-xl border-2 border-slate-50 flex items-center gap-2 justify-center text-center hover:scale-110 transition-all cursor-pointer"
            ...
            {isSearched && (
                <button
                    ...
                    className="w-16 h-full flex items-center justify-center cursor-pointer border-2 border-slate-200 rounded-xl"
                >
                    Clear
                </button>
            )}
